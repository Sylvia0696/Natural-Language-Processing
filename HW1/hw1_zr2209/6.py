...
os.system("python count_freqs.py ner_train_new.dat > ner_new.counts")
            ...
            for v in s:
                ...
                for w in s:
                    ...
                    if x_k[k] not in xset:
                        if x_k[k].istitle():
                            modified_x = '_PROPER_NAME_'
                        else:
                            if x_k[k].isupper():               
                                modified_x = '_FIRST_NAME_'         
                            elif x_k[k].isdigit():
                                modified_x = '_NUMBER_'
                            else:
                                modified_x = '_RARE_'
